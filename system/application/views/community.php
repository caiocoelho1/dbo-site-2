<div class='message'  style='overflow: hidden; width: 30%; float: left;'>
	<div class='title'>Últimos videos</div>
	<div class='content'>
		<?php 
			if(empty($videos))
				echo "Não há videos!";
...
<div class='message'  style='overflow: hidden; width: 350px; float: right; margin-left: 20px; margin-bottom: 10px;'>
	<div class='title'>Últimos comentários</div>
		<?php 
			if(empty($comments))
				...
				foreach($comments as $comment) {
					echo "<div style='border-bottom: 1px dotted silver; margin-bottom: 5px; padding: 5px;'><b>Autor</b>: ".$comment['author']." &nbsp; ".ago($comment['time'])."<br/>".$comment['body']."<br/><br/></div>";
				}
				echo "</div>";
			}
		?>
...
<div class='message' style='overflow: hidden; width: 350px; float: right; margin-left: 20px; margin-bottom: 10px;'>
	<div class='title'>Facebook Social</div>
	<div class='content'>
